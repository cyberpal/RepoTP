CREATE TABLE [dbo].[Cliente_Unico] (
    ...
    CONSTRAINT [PK_Cliente_Unico_Id] PRIMARY KEY CLUSTERED ([Cliente_Unico_Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IX_numero_identificacion]
    ON [dbo].[Cliente_Unico]([numero_identificacion] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_numero_tarjeta]
    ON [dbo].[Cliente_Unico]([numero_tarjeta] ASC);
