CREATE TABLE [dbo].[Medio_De_Pago] (
    ...
    [version]                           INT             CONSTRAINT [DF_Medio_De_Pago_version] DEFAULT ((0)) NOT NULL,
    [flag_informa_rubro]                BIT             CONSTRAINT [DF_Medio_De_Pago__flag_inf_rubro] DEFAULT ((0)) NULL,
    [plazo_devolucion]                  INT             CONSTRAINT [DF_Medio_De_Pago__plazo_devolucion] DEFAULT (NULL) NULL,
    [flag_permite_anulacion]            BIT             CONSTRAINT [DF_Medio_De_Pago__flag_permite_anulacion] DEFAULT ((0)) NOT NULL,
    [flag_permite_devolucion]           BIT             CONSTRAINT [DF_Medio_De_Pago__flag_permite_devolucion] DEFAULT ((0)) NOT NULL,
    [flag_permite_segundo_vto]          BIT             CONSTRAINT [DF_Medio_De_Pago__flag_permite_segundo_vto] DEFAULT ((0)) NULL,
    ...
    [flag_permite_transaccion_sin_cvv]  BIT             DEFAULT ((0)) NOT NULL,
    ...
    [flag_permite_devolucion_sin_cvv]   BIT             CONSTRAINT [DF_Medio_De_Pago_flag_permite_devolucion_sin_cvv] DEFAULT ((0)) NOT NULL,
    [flag_permite_anulacion_devolucion] BIT             DEFAULT ((0)) NOT NULL,
    [flag_habilitado_bvtp]              BIT             DEFAULT ((1)) NOT NULL,
    [tokenizador]                       VARCHAR (255)   NULL,
    [flag_habilitado_pei]               BIT             DEFAULT ((0)) NOT NULL,
    CONSTRAINT [PK_Medio_De_Pago] PRIMARY KEY CLUSTERED ([id_medio_pago] ASC) WITH (FILLFACTOR = 80),
    CONSTRAINT [FK_Medio_De_Pago_Resolutor] FOREIGN KEY ([id_resolutor]) REFERENCES [dbo].[Resolutor_Transaccion] ([id_resolutor]),
    CONSTRAINT [FK_Medio_De_Pago_Tipo_Medio_Pago] FOREIGN KEY ([id_tipo_medio_pago]) REFERENCES [dbo].[Tipo_Medio_Pago] ([id_tipo_medio_pago])
);
