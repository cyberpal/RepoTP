...
BEGIN TRY
   ...
   SELECT SUBSTRING(detalles,13,1),
    ...
    LEFT JOIN Configurations.dbo.Codigo_Operacion_Medio_Pago comp
           ON comp.id_medio_pago = @id_medio_pago AND comp.valor_1 = SUBSTRING(detalles,34,4) 
   ...
   IF(@flag_fecha < 0)
    ...
    ELSE IF(@cantidad_detalles < 1)
      BEGIN
        SET @motivo_rechazo = 'La cantidad de registros de detalle de transacciones de ser mayor o igual a 1.';
      END
