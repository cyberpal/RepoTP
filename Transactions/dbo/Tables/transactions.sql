...
CREATE TABLE [dbo].[transactions] (
    ...
    [CredentialBirthday]               DATETIME        NULL,
    ...
    [CouponSecondExpirationDate]       DATETIME        NULL,
    ...
    [flag_formulario_cargado]          BIT             DEFAULT ((0)) NOT NULL,
    ...
    [MinInstallments]                  INT             NULL,
    [TxInputMode]                      VARCHAR (10)    NULL,
    PRIMARY KEY CLUSTERED ([Id] ASC) WITH (FILLFACTOR = 95)
);


GO
CREATE NONCLUSTERED INDEX [CreateTstamp_Tr_Trn]
    ON [dbo].[transactions]([CreateTimestamp] ASC) WITH (FILLFACTOR = 95);


GO
CREATE NONCLUSTERED INDEX [idx_Batch_Disponible_ObtenerRegistros]
    ON [dbo].[transactions]([LiquidationStatus] ASC, [AvailableTimestamp] ASC, [TransactionStatus] ASC, [LocationIdentification] ASC, [LiquidationTimestamp] ASC, [AvailableStatus] ASC, [CashoutTimestamp] ASC)
    INCLUDE([Id], [OperationName], [Amount], [FeeAmount], [TaxAmount]) WITH (FILLFACTOR = 95);


GO
CREATE NONCLUSTERED INDEX [idx_batch_liquidaciones]
    ON [dbo].[transactions]([ResultCode] ASC, [LiquidationTimestamp] ASC, [FeeAmount] ASC, [TaxAmount] ASC, [LiquidationStatus] ASC, [TransactionStatus] ASC)
    INCLUDE([Id], [CreateTimestamp], [LocationIdentification], [OperationName], [ProductIdentification], [FacilitiesPayments], [Amount], [CredentialMask], [CredentialDocumentType], [CredentialDocumentNumber], [CashoutTimestamp], [FilingDeadline], [PaymentTimestamp], [OriginalOperationId], [BuyerAccountIdentification], [PromotionIdentification], [AdditionalData]) WITH (FILLFACTOR = 95);


GO
CREATE NONCLUSTERED INDEX [Idx_result_Liq_TrxStat_LiqStat]
    ON [dbo].[transactions]([ResultCode] ASC, [LiquidationTimestamp] ASC, [TransactionStatus] ASC, [LiquidationStatus] ASC) WITH (FILLFACTOR = 90);


GO
CREATE NONCLUSTERED INDEX [idx_resultcode_originalOPid]
    ON [dbo].[transactions]([ResultCode] ASC, [OriginalOperationId] ASC)
    INCLUDE([FeeAmount], [TaxAmount]) WITH (FILLFACTOR = 95);


GO
CREATE NONCLUSTERED INDEX [IX_Transactions_OriginalOperationId]
    ON [dbo].[transactions]([OriginalOperationId] ASC) WITH (FILLFACTOR = 95);


GO
CREATE UNIQUE NONCLUSTERED INDEX [PK_transactions]
    ON [dbo].[transactions]([Id] ASC) WITH (FILLFACTOR = 95);


GO
CREATE NONCLUSTERED INDEX [transactions_CreateTimestamp_ResultCode]
    ON [dbo].[transactions]([CreateTimestamp] ASC, [ResultCode] ASC)
    INCLUDE([Id], [LocationIdentification], [OperationName], [ProviderTransactionID], [ProductIdentification], [FacilitiesPayments], [CurrencyCode], [Amount], [FeeAmount], [TaxAmount], [CredentialMask], [CredentialHolderName], [CredentialEmailAddress], [ResultMessage], [Channel], [CouponExpirationDate], [LiquidationStatus], [LiquidationTimestamp], [AvailableTimestamp], [SaleConcept], [ChargebackStatus], [CashoutTimestamp], [PaymentTimestamp], [CouponStatus], [OriginalOperationId], [TransactionStatus], [ProductType], [BankIdentification], [BuyerAccountIdentification], [AmountBuyer], [TaxAmountBuyer]) WITH (FILLFACTOR = 95);


GO
CREATE NONCLUSTERED INDEX [idx_SyncStatus_Batch_Sincronizador]
    ON [dbo].[transactions]([SyncStatus] ASC)
    INCLUDE([Id], [FeeAmount], [TaxAmount], [ReverseStatus], [ReverseTimestamp], [LiquidationStatus], [LiquidationTimestamp], [ReconciliationStatus], [ReconciliationTimestamp], [AvailableStatus], [AvailableTimestamp], [BillingStatus], [BillingTimestamp], [ChargebackStatus], [ChargebackTimestamp], [CashoutStatus], [CashoutTimestamp], [FilingDeadline], [PaymentTimestamp], [CouponStatus], [TransactionStatus], [FeeAmountBuyer], [TaxAmountBuyer], [PresentationTimestamp], [DocumentationTimestamp], [DocumentationURL], [CashoutReleaseStatus], [CashoutReleaseTimestamp]);


GO
CREATE NONCLUSTERED INDEX [idx_BatchFacturacion_tran_Billing_Liquid]
    ON [dbo].[transactions]([LiquidationStatus] ASC, [BillingStatus] ASC, [BillingTimestamp] ASC, [CreateTimestamp] ASC, [LiquidationTimestamp] ASC)
    INCLUDE([Id], [LocationIdentification], [OperationName], [FeeAmount], [TaxAmount]);


GO
CREATE NONCLUSTERED INDEX [idx_batchFacturacion_Actualizar_Procesados]
    ON [dbo].[transactions]([LocationIdentification] ASC, [LiquidationStatus] ASC, [BillingTimestamp] ASC, [CreateTimestamp] ASC, [LiquidationTimestamp] ASC, [BillingStatus] ASC)
    INCLUDE([Id], [OperationName], [SyncStatus]);


GO
CREATE NONCLUSTERED INDEX [NCI_ProviderTransactionID-20160901]
    ON [dbo].[transactions]([ProviderTransactionID] ASC);


GO
CREATE NONCLUSTERED INDEX [IdxCreateTimestamp]
    ON [dbo].[transactions]([CreateTimestamp] ASC);


GO
CREATE NONCLUSTERED INDEX [IdxUpdateTimestamp]
    ON [dbo].[transactions]([UpdateTimestamp] ASC);


GO
CREATE NONCLUSTERED INDEX [IdxBillingTimestamp]
    ON [dbo].[transactions]([BillingTimestamp] ASC);
