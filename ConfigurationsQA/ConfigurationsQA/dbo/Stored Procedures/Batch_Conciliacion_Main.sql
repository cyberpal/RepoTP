...
SET NOCOUNT ON;
    ...
    SELECT
		...
		@cant_tx_pagofacil = SUM(CASE WHEN  descripcion = 'PAGOFACIL' THEN 1 ELSE 0 END)
    ...
    WHILE(@cant_tx_rapipago > 0)
	   ...
	   END
	WHILE(@cant_tx_pagofacil > 0)
       BEGIN
	     EXEC Configurations.dbo.Batch_Conciliacion_ValidarPagofacil 
	          @id_log_proceso;
		   
	     SET @cant_tx_pagofacil = @cant_tx_pagofacil - 1;
	   END
